...
\usetheme{Madrid}
\definecolor {ElVioleta}{RGB}{122,59,122}
\definecolor {ElAzul}{RGB}{0,88,147}
\definecolor {ElGris}{RGB}{56,61,66}

\setbeamercolor*{palette primary}{use=structure, fg=white, bg=ElVioleta}
\setbeamercolor*{palette secundary}{use=structure, fg=white, bg=ElAzul}
\setbeamercolor*{palette tertiary}{use=structure, fg=white, bg=ElGris}
